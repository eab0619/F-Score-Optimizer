...
myCompData <- compareRecords(
  df1, 
  df2, 
  flds=c("first_name", "last_name", "middle_name", "birth_year"),
  types=c(rep("lv", 2), rep("bi", 1), rep("bi", 1))
)
Zchain <- bipartiteGibbs(myCompData, nIter=1000, seed=0)$Z[, 1:1000]
